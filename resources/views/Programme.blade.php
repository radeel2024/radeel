...
<head>
    ...
    <style>
        .page-headere {
            background: linear-gradient(rgba(0, 0, 0, .6), rgba(0, 0, 0, .6)), url(https://www.iae-bordeaux.fr/application/files/2915/9404/5922/Article_Master_Gestion_RH_960x540.jpg) center center no-repeat;
            ...
            <div class="  row g-5">
                <div class=" col-lg-5 col-md-6 col-sm-12 wow fadeIn" data-wow-delay=".3s">
                    <div class="h-100 position-relative">
                        <img src="articlescopie/programme1.jpg" class="img-fluid shadow-sm w-85 rounded"
                            style="width:100%; height: 350px;"><br><br>
                    </div>
                </div>
                <div class="col-lg-7 col-md-6 col-sm-12 wow fadeIn" data-wow-delay=".5s"><br>
                    <h1 style="color:#D6821E;"> <a  style="color:#D6821E;"
                            width="100%">Programme prévisionnel</a> </h1><br>
                    <p>Conformément à l’article 14 du règlement relatif aux conditions et formes de passation des
                        ...
                        Régie Autonome Intercommunale de Distribution d’Eau et d’Electricité de la Province de Larache
                        publie à titre indicatif et dans le but d’information, le programme prévisionnel qu’elle
                        envisage de lancer au titre de l’année budgétaire <a href="#detail" style="color:#D6821E;">...
                            En savoir plus...</a>
                    </p>
                </div>
                <div class="container">
                    <h2 class="text-center py-3" style="color:#077ec0">Guide de programme prévisionnel </h2><br><br>

                    <div class=" h-100 position-relative" id="detail">
                        <div class="container" id="reglement">
                            <embed src="/img/programme-previsionnel-2022.pdf" type="application/pdf" width="100%" height="700">
                        </div>
                    </div>
                    <br><br>
                </div>
