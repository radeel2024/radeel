...
<body>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white py-lg-0 px-lg-3">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class=" navbar-nav  ms-auto">
                        ...
                        <div class="nav-item dropdown">
                            <a href="{{ url('../') }}" class="nav-item dropdown-toggl active"
    ...
    <div class="container-fluid page-headere py-5">
        <div class="container text-center py-5">
            <h1 class="display-2 text-white mb-4 animated slideInDown">Programme prévisionnel
            </h1>
        </div>
    </div>
    <!-- Page Header End -->
            ...
            <div class="  row g-5">
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-6 col-sm-12 wow fadeIn" data-wow-delay=".5s">
                        <h1 style="color:#077ec0;">
                            <a style="color:#077ec0;" width="100%">Programme prévisionnel</a>
                        </h1><br>
                        <p>
                            Conformément à l’article 14 du règlement relatif aux conditions et formes de passation des
                            marchés de la régie autonome de distribution d’eau et d’électricité de Larache (RADEEL), la
                            Régie Autonome Intercommunale de Distribution d’Eau et d’Electricité de la Province de
                            Larache publie à titre indicatif et dans le but d’information, le programme prévisionnel
                            qu’elle envisage de lancer au titre de l’année budgétaire
                            <a href="#detail" style="color:#077ec0;">En savoir plus...</a>
                        </p>
                    </div>

                    <!-- Image Section -->
                    <div class="col-lg-5 col-md-6 col-sm-12 wow fadeIn d-flex flex-column flex-md-row"
                        data-wow-delay=".3s">
                        <div class="h-100 position-relative">
                            <img src="img/programme.png" class="img-fluid shadow-sm w-85 rounded" style="width:100%;">
                        </div>
                    </div>
                </div>

                <div class="container">
                    <h2 class="text-center py-3" style="color:#077ec0">Programme prévisionnel </h2><br><br>

                    <div class=" h-100 position-relative" id="detail">
                        <div class="container" id="reglement">
                            <embed src="/images/programme 2024.pdf" type="application/pdf" width="100%" height="800" >
                        </div>
                    </div>
                    <br><br>
                </div>
