            ...
            <div class="  row g-5">
                <div class=" col-lg-5 col-md-6 col-sm-12 wow fadeIn" data-wow-delay=".3s">
                    <div class="h-100 position-relative">
                        <img src="img/programme.png" class="img-fluid shadow-sm w-85 rounded"
                            style="width:100%;"><br><br>
                    </div>
                </div>
                <div class="col-lg-7 col-md-6 col-sm-12 wow fadeIn" data-wow-delay=".5s"><br>
                    <h1 style="color:#077ec0;"> <a  style="color:#077ec0;"
                    ...
                    <p>Conformément à l’article 14 du règlement relatif aux conditions et formes de passation des
                        ...
                        envisage de lancer au titre de l’année budgétaire <a href="#detail" style="color:#077ec0;">...
                            En savoir plus...</a>
                    </p>
                </div>
                <div class="container">
