        ...
        <nav id="navbarNav navbar-expand-sm " class="navbar ">
         <button class="navbar-toggler" type="button" data-bs-toggle="collapse"
            ...
            <ul>
                ...
                <li class="dropdown" style="color:black;"><a class="nav-link active"><span>ESPACE RH</span> <i
                            class="bi bi-chevron-down"></i></a>
                    <ul>
        ...
        <div class="container" bis_skin_checked="1">
            <div class="row g-5 align-items-center" bis_skin_checked="1">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s"
                    ...
                    <p><i class="fa fa-check  me-3" style="color:orange;padding-left:20px;"></i>
                        <span style="font-weight:200; ">Une assurance couvrant la période de stage</span>
                    </p>
                    <p><i class="fa fa-check  me-3" style="color:orange;padding-left:20px;"></i>
                        <span style="font-weight:200;"> Une copie de la carte nationale d'identité (CIN)</span>
                    </p>
                    <p><i class="fa fa-check me-3" style="color:orange;padding-left:20px;"></i>
                        <span style="font-weight:200;">Pass sanitaire</span>
                    ...
                    <p class="mb-4"> si vous etes intéresser de faire chez nous un stage merci de vous deposer votre
                        ...
                        <br><br>
                        <button type="button" style="background-color:#058dd4; color:white ; font-size:18px; padding:20px;" class="btn btn"
                ...
                <div class="col-lg-6" bis_skin_checked="1">
                    <div class="rounded overflow-hidden" bis_skin_checked="1">
                        ...
                        <div><img
                                src="https://www.digitalrecruiters.com/medias/2021/09/entretien-dembauche-devenez-un-pro.jpg"
                                style="background-size:
                                    cover;background-repeat:
                                    no-repeat;background-position: right;height: 400px;"
                                width="100%">
                        </div>
                    ...
                    <form method="POST" action="{{ route('addstage') }}" id="multi-step-form" style="Padding:30px;"
                        ...
                        <div class="step step-1">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="tel" name="tele" class="form-control" id="numTel"
                                    placeholder="0600000000" maxlength="10" oninput="" required="required">
                            </div>
                            <div class="mb-3">
                        ...
                        <div class="step step-2">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control form-control" name="cv" id="formFileLg"
                                    type="file" required>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Demande de Stage
                                </label>
                                <input class="form-control form-control" name="demande" id="formFileLg"
                                    type="file" required>
                            </div>
                            <div class="mb-3">
                                <label class="form-label"> Une assurance couvrant la période de stage
                                </label>
                                <input class="form-control form-control" name="assurance" id="formFileLg"
                                    type="file" required>
                            </div>
                            <div class="mb-3">
                                ...
                                <input class="form-control form-control" name="cin" id="formFileLg"
                                    type="file" required>
                            </div>
                            <div class="mb-3">
