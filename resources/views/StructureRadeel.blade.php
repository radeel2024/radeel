...
<html lang="en">
    ...
    <head>
        ...
        <style>
            .page-headere {
                   background: linear-gradient(rgba(0, 0, 0, .6), rgba(0, 0, 0, .6)), url(https://i.ibb.co/PZjP8dD/head.png) center center no-repeat;
    ...
    <body>
    <div class="container-fluid  py-2 d-none d-md-flex" style="background: #077ec0;font-size:18px; color:#4d4D4D;font-family:arial;">
        <div class="container">
        ...
        <nav id="navbarNav navbar-expand-sm " class="navbar ">
         <button class="navbar-toggler" type="button" data-bs-toggle="collapse"
            ...
            <ul>
                ...
                <li class="dropdown"><a class="nav-link scrollto active"><span>RADEEL</span> <i class="bi bi-chevron-down"></i></a>
                    <ul>
         ...
         <!-- Page presentation RADEEL  -->
          <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s" id="Structure">
            <div class="container py-5">
                <div class="row ">
                    <div class="col-lg">
                        <p class="section-body position-relative pb-3 mb-5">La RADEEL est administrée par un Conseil d’Administration et un comité de Direction. L’ensemble des services est géré par le Directeur Général.</p>
                        <img src="https://www.radeel.ma/images/radeel-images/organigramme.png" width="100%" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
