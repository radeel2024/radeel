...
<head>
    ...
    <style>
        .page-headere {
            background: linear-gradient(rgba(0, 0, 0, .6), rgba(0, 0, 0, .6)), url(https://vivetic-group.com/wp-content/uploads/2022/12/Saisie-de-donees_couverture_1200x450-1200x400.jpg) center center no-repeat;
        ...
        <div class="container d-flex justify-content-between">
            ...
            <nav id="navbarNav navbar-expand-sm " class="navbar ">
                ...
                <ul>
                    ...
                    <li class="dropdown"><a><span>ESPACE CLIENT</span> <i class="bi bi-chevron-down"></i></a>
                        <ul>
                    ...
                    <li class="dropdown"><a><span>ESPACE RH</span> <i class="bi bi-chevron-down"></i></a>
                        <ul>
 ...
 -->
    ...
    <div class="container-fluid page-headere py-5">
        <div class="container text-center py-5">
            <h1 class="display-2 text-white mb-4 animated slideInDown">Demande Saisie</h1>
        </div>
    </div>
    ...
    <div class="container " bis_skin_checked="1">
        <div class="container " bis_skin_checked="1" style="background-color:#ffff">
            <br><br><br>
            <a href="http://localhost/premier%20projet/formulaire.php">ege</a>
            <br><br><br>
        </div>
    </div>
    ...
    <!-- Contact v2 -->
    <!--  <div class="container-fluid contact py-5" bis_skin_checked="1" >
            <div class="container py-5" bis_skin_checked="1" >
                <div class="p-5  rounded" bis_skin_checked="1" style="background-image:linear-gradient(#077ec0,white);" >
                    <div class="row g-4" bis_skin_checked="1"  >
                        <div class="col-12" bis_skin_checked="1">
                            <div class="text-center mx-auto" style="max-width: 700px;" bis_skin_checked="1">
                                <h1 class="text-light">Contactez Nous</h1>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-7" bis_skin_checked="1">
                            ...
                            <form action="" class="">
                                ...
                                <input type="text" class="w-100 form-control border-0 py-3 mb-4" placeholder="Your Prenom">
                                <input type="text" class="w-100 form-control border-0 py-3 mb-4" placeholder="Objet">
                                <input type="email" class="w-100 form-control border-0 py-3 mb-4" placeholder="Enter Your Email">
                                <textarea class="w-100 form-control border-0 mb-4" rows="5" cols="10" placeholder="Your Message"></textarea>
                                <button class="w-100 btn form-control border-primary py-3 bg-white text-primary " type="submit">Envoyé</button>
                            </form>
                        </div>
                        <div class="col-lg" bis_skin_checked="1">
                            <div class="d-flex p-4 rounded mb-4 bg-white" bis_skin_checked="1">
                                <i class="fas fa-map-marker-alt fa-2x text-primary me-4"></i>
                                <div bis_skin_checked="1">
                                    <h4>Address</h4>
                                    <p class="mb-2">N, BP:11, 1647 Lotisment</p>
                                </div>
                            </div>
                            <div class="d-flex p-4 rounded mb-4 bg-white" bis_skin_checked="1">
                                ...
                                <div bis_skin_checked="1">
                                    <h4>Email </h4>
                                    <p class="mb-2">radeel@radeel.com</p>
                                </div>
                            </div>
                            <div class="d-flex p-4 rounded bg-white" bis_skin_checked="1">
                                <i class="fa fa-phone-alt fa-2x text-primary me-4"></i>
                                <div bis_skin_checked="1">
                                    <h4>Telephone</h4>
                                    <p class="mb-2">0801 000 042</p>
                                </div>
                            </div>
                            <br>
                            <div class="d-flex p-4 rounded bg-white" bis_skin_checked="1">
        ...
        <div class="container pt-5 pb-4">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="mt-4 d-flex flex-column short-link">
                        <a href="{{ url('../') }}" class="mb-2 text-white"><i class="fas fa-angle-right text me-2"
                                style="color: orange;"></i>RADEEL</a>
                        <a href="{{ url('../') }}#contact" class="mb-2 text-white"><i
                                class="fas fa-angle-right text me-2" style="color: orange;"></i>Contact</a>
                        <a href="{{ url('../Abonnement') }}" class="mb-2 text-white"><i
                                class="fas fa-angle-right text me-2" style="color: orange;"></i>Espaces
                            clients</a>
                        <a href="{{ url('../loi') }}" class="mb-2 text-white"><i class="fas fa-angle-right text- me-2"
                                style="color: orange;"></i>Espaces RH</a>
                        <a href="{{ url('../ResultatOffre') }}" class="mb-2 text-white"><i
                                class="fas fa-angle-right text me-2" style="color: orange;"></i>Fournisseurs</a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
            ...
            <div class="row">
                <div class="col-md-6 text-center text-md-start">
                    <span class="text-light text-center"><a href="#" class="text-center"><i class="fas fa-copyright ">
