        ...
        <nav id="navbarNav navbar-expand-sm " class="navbar ">
         <button class="navbar-toggler" type="button" data-bs-toggle="collapse"
            ...
            <ul>
                ...
                <li class="dropdown"><a ><span>ESPACE CLIENT</span> <i
                ...
                <li class="dropdown"><a ><span>ESPACE RH</span> <i
                            class="bi bi-chevron-down"></i></a>
                    <ul>
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="mt-4 d-flex flex-column short-link">
                            <a href="{{ url('../') }}" class="mb-2 text-white"><i
                                    class="fas fa-angle-right text me-2" style="color: orange;"></i>RADEEL</a>
                            ...
                            <a href="{{ url('../loi') }}" class="mb-2 text-white"><i
                                    class="fas fa-angle-right text- me-2" style="color: orange;"></i>Espaces RH</a>
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="mt-4 d-flex flex-column help-link">
                            <a href="{{ url('../') }}" class="mb-2 text-white"><i
                                    class="fas fa-angle-right text me-2" style="color: orange;;"></i>Mentions
                                légales</a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
