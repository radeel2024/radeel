...
<html lang="en">
    ...
    <head>
        ...
        <style>
            .page-headere {
                    background: linear-gradient(rgba(0, 0, 0, .3), rgba(0, 0, 0, .3)), url(https://previews.123rf.com/images/smolaw11/smolaw111804/smolaw11180400015/99363001-lyc%C3%A9en-ou-%C3%A9tudiant-universitaire-mains-prenant-des-examens-examen-%C3%A9crit-sur-une-feuille-de-r%C3%A9ponse.jpg) center center no-repeat;
    ...
    <body>
        <!-- Spinner Start -->
        <div id="spinner" class="show position-fixed translate-middle w-100
        ...
        <!-- Topbar Start -->
        <div class="container-fluid py-2 d-none d-md-flex" style="background:
            #077ec0;">
            <div class="container">
                <div class="d-flex justify-content-between topbar">
                    <div class="top-info">
                        <small class="me-3 text-white"><i class="fas fa-envelope
                                text-white"></i>Radeel@Radeel.com</small>
                        <small class="me-3 text-white"><i class="fas
                                fa-map-marker-alt text-white"></i> N, BP:11,
                            1647 Lotisment </small>
                    </div>
                    <div id="note" class="text-white d-none d-xl-flex"><small>ALL
                            Radeel 08 01 00 00 42</small></div>
                    <div class="top-link">
                        <a href="" class="bg-light nav-fill btn btn-sm-square
                            rounded-circle">
                            <i class="fab fa-facebook-f" style="color:
                                #077ec0;"></i></a>
                        <a href="" class="bg-light nav-fill btn btn-sm-square
                            rounded-circle">
                        ...
                        <a href="" class="bg-light nav-fill btn btn-sm-square
                            rounded-circle">
                            <i class="fab fa-instagram" style="color:
                                #077ec0;font-weight: 900;"></i>
                        </a>
                        <a href="" class="bg-light nav-fill btn btn-sm-square
                            rounded-circle me-0">
                            <i class="fab fa-linkedin-in" style="color:
                                #077ec0;"></i></a>&nbsp;&nbsp;
                        <a href="" class="bg-light nav-fill btn btn-sm-square
                            rounded-circle me-0">
                            <i class="fas fa-headset" style="color:
                                #077ec0;font-weight: bold;"></i></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- Navbar Start -->
        <div class="container-fluid sticky-top shadow-lg bg-white">
            <div class="container">
                <nav class="navbar navbar-expand-lg py-0 ">
                    <a href="index.html" class="navbar-brand">
                        <h1 class="text-white fw-bold d-block"><img
                                src="https://www.radeel.ma/images/radeel-logo-1x1.png"
                                width="70"> </h1>
                    </a>
                    ...
                    <div class="collapse navbar-collapse bg-transparent"
                        id="navbarCollapse" style="padding-left:400px;">
                        <div class="navbar-nav ms-auto mx-xl-auto p-0">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu rounded">
                                    <a href="blog.html" class="dropdown-item">Our
                                        Blog</a>
                            ...
                            <div class="nav-item dropdown">
                                <a href="#serviceID" class="nav-link
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu rounded">
                                    <a href="blog.html" class="dropdown-item">Loi
                                        cadre</a>
                                    <a href="team.html" class="dropdown-item">Avis
                                        de recrutement</a>
                                    <a href="testimonial.html"
                                        class="dropdown-item">Résultats des
                                        concours</a>
                                    <a href="404.html" class="dropdown-item">Appel
                                        à la candidature</a>
                                    <a href="404.html" class="dropdown-item">Stages</a>
                                </div>
                            </div>
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle"
                            ...
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle"
                                    data-bs-toggle="dropdown">Pratiques</a>
                                <div class="dropdown-menu rounded">
                                    <a href="blog.html" class="dropdown-item">Our
                                        Blog</a>
                                    <a href="team.html" class="dropdown-item">Our
                            ...
                            <a href="#contactID" class="nav-item nav-link">Contact</a>
                        </div>
                    </div>
        ...
        <div class="container-fluid page-headere py-5">
            <div class="container text-center py-5">
                <h1 class="display-2 text-white mb-4 animated slideInDown"> Resultats des concours </h1>
            </div>
        </div>
        ...
        <div class="container-fluid py-3 my-3">
            ...
            <div class="container py-5">
                ...
                <table class="table table-hover table-striped">
                    ...
                    <tbody>
                        <tr>
                            <td><strong><a href="#">LA LISTE DES RÉSULTATS DÉFINITIFS PAR ORDRE DE MERITE DU CONCOURS DE RECRUTEMENT A LA RADEEL 2023</a></strong></td>
                        </tr>
                        <tr>
                            <td><a href="#"><strong>LISTES DES CANDIDATS CONVOQUÉS POUR PASSER LES ÉPREUVES ORALES DU CONCOURS D'ADMISSIBILITÉ DE LA RADEEL - Année 2023-</strong></a></td>
                        </tr>
                        <tr>
                            <td><a href="#"><strong>LISTE DES CANDIDATS CONVOQUES POUR PARTICIPER AU CONCOURS D'ADMISSIBILITÉ DE LA RADEEL - Année 2023-</strong></a></td>
                        </tr>
                        <tr>
                            <td><a href="#"><strong>LA LISTE DES RÉSULTATS DÉFINITIFS PAR ORDRE DE MERITE DU CONCOURS DE RECRUTEMENT A LA RADEEL 2022</strong></a></td>
                        </tr>
                        <tr>
                            <td><a href="#"><strong>LISTE DES CANDIDATS CONVOQUES POUR PARTICIPER AU CONCOURS D'ADMISSIBILITÉ DE LA RADEEL - Année 2022-</strong></a></td>
                        </tr>
                        <tr>
                            <td><a href="#"><strong>LA LISTE DES RÉSULTATS DÉFINITIFS PAR ORDRE DE MERITE DU CONCOURS DE RECRUTEMENT A LA RADEEL 2021</strong></a></td>
                        </tr>
...
<a href="tel:0801000042" class="allo">
    ...
    <span class="allotext">Allo RADEEL</span>
        ...
        <!-- Back to Top -->
        <a href="#" class="btn btn-secondary btn-square rounded-circle
            back-to-top"><i class="fa fa-arrow-up text-white"></i></a>
