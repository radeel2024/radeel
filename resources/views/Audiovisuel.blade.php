                        ...
                        <div class="col">
                            ...
                            <ul class="nav nav-pills justify-content-center mb-3 direction-rtl" id="pills-tab"
                                ...
                                <li class="nav-item" id="nav-link-1">
                                    <a class="elec btn btn-rounded " id="pills-first-tab" data-toggle="pill"
                                ...
                                <li class="nav-item" id="nav-link-3">
                                    <a class="assa btn btn-rounded active" id="pills-third-tab" data-toggle="pill"
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade" id="pills-first" role="tabpanel"
                                ...
                                <div class="tab-pane fade active show" id="pills-third" role="tabpanel"
