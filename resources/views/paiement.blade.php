...
*/
    ...
    <div class="container-fluid page-headere py-5" >
        <div class="container text-center py-5">
            <h1 class="display-2 text-white mb-4 animated slideInDown">Paiement en ligne </h1>
        </div>
    </div>
    <!-- Page Header End -->
            ...
            <div class="  row g-5">
                <div class=" col-lg-5 col-md-6 col-sm-12 wow fadeIn" data-wow-delay=".3s">
                    <div class="h-100 position-relative">
                        <img src="img/paiment.png" class="img-fluid shadow-sm w-85 rounded"
                            style="width:100%; height: 450px;"><br><br>
                    </div>
                </div>
                <div class="col-lg-7 col-md-6 col-sm-12 wow fadeIn" data-wow-delay=".5s"><br>
                    ...
                    <p>
                        Le service de paiement en ligne vous permet de régler vos factures d'eau et d'électricité en
                        tête sublicité et sécurité : 24h/24 et 7j/7 depris votre ordinateur ou téléphone mobile .
                    </p>
                    <p><a href="https://www.fatourati.ma/FatLite/ma/MTC/formulaire?fid=1040" class="btn btn"
                            style='background-color:#077ec0; color: white;padding:15px;'> <i
                                class="fas fa-credit-card"></i> Payer vos factures </a></p>

                </div>
                <div class="container">
                    <h2 class="text-center py-3" style="color:rgb(155,187,89)">Guide de paiement en ligne </h2><br><br>

                    <div class=" h-100 position-relative">
                        <img src="img/paiement-guide.gif" class="img-fluid  rounded">
                        <p style="margin:50px; text-align:center; "><a
                                href="https://www.fatourati.ma/FatLite/ma/MTC/formulaire?fid=1040" class="btn btn"
                                style='background-color:#077ec0; color: white;padding:15px;'> <i
                                    class="fas fa-credit-card"></i> Payer vos factures </a></p>
