                ...
                <div class="d-flex justify-content-between topbar">
                    <div class="top-info">
                        <small class="me-3 text-white"><i class="fas fa-envelope text-white"></i><a
                                href="mailto:info@Radeel.com" style="color:white; font-size:14px;"> reclamation@radeel.com</a></small>
                        <small class="me-3 text-white"><i class="fas fa-map-marker-alt text-white"></i>
                            <a style="color:white;text-decoration: none;text-decoration: none;  font-size:14px;"
        ...
        <nav id="navbarNav navbar-expand-sm " class="navbar ">
         <button class="navbar-toggler" type="button" data-bs-toggle="collapse"
            ...
            <ul>
                ...
                <li><a class="nav-link scrollto" href="{{url('../')}}#contact">CONTACTS</a></li>
                &nbsp;&nbsp;&nbsp;&nbsp;
                <li class="dropdown">
...
<!-- Navbar End -->
                ...
                <div class="  row g-5">
                    <div class=" col-lg-5 col-md-6 col-sm-12 wow fadeIn" data-wow-delay=".3s">
                        <div class="h-100 position-relative">
                            <img src="img/paiementradeel.jpg" class="img-fluid shadow-sm w-85 rounded" style="width:100%; height: 350px;"  ><br><br>
                        </div>
                    </div>
    ...
    <script >
       ...
       $('#modalIndex').modal('show')});</script>    </body>
