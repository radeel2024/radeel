            ...
            <li class="nav-item">
                ...
                <div id="collapsefoure" class="collapse show" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        @can('commerciale')
                            <a class="collapse-item active" href="{{ route('statistiqueCom') }}"><strong>
                                    Commercial</strong></a>
                        @endcan
                ...
                <div id="content">
                    ...
                    <div class="container img-fluid">
                        ...
                        <script>
                            ...
                            var xValues = ["Abonnements", "Racordements", "Résiliations"];
                            var yValues = [{{ $abonement }}, {{ $racor }}, {{ $resil }}];
                            var barColors = ["gray", "orange", "#146998"]; // You can change the colors as needed
