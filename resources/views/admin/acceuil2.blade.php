            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        @endcan
                        @can('communication')
                            <a class="collapse-item active" href="{{ route('communication') }}"><strong>Annonce</strong></a>
                        @endcan
                        @can('commerciale')
                        ...
                        @endcan
                        @can('galerie')
                            <a class="collapse-item " href="{{ route('album') }}"><strong>SMS</strong></a>
                        @endcan
            ...
            <li class="nav-item">
                ...
                <div id="collapsefoure" class="collapse " aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item " href="{{ route('statistiqueCom') }}"><strong>
                                Commercial</strong></a>

                        <a class="collapse-item" href="{{ route('statistiqueachatlo') }}"><strong> Ressources
                                Humaines</strong></a>

                        <a class="collapse-item" href="{{ route('statistiquerh') }}"><strong>Achat et
                                Logistique</strong></a>
                        ...
                        <div class="col-lg-4 shadow-sm py-3" bis_skin_checked="1">
                            <div class="container " bis_skin_checked="1">
                                <div class="card-body text-center" bis_skin_checked="1">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <h1 id="displayedTitre" style="color: black; margin-top: 10px; ">
                                                @foreach ($annoncefilter as $an)
                                                    {{ $an->titre }}
                                                @endforeach
                                            </h1>

                                            <p id="displayedDescription" style="color: black; margin-top: 10px; ">
                                                @foreach ($annoncefilter as $an)
                                                    {{ $an->des }}
                                                @endforeach
                                            </p>
                                            @foreach ($annoncefilter as $an)
                                                <img src="{{ asset('annonce/' . $an->imageannonce) }}"
                                                    id="selectedImage" style="max-width: 100%; margin-top: 10px;"
                                                    class="img-fluid">
                                            @endforeach
                                ...
                                <h5 style="color:black;margin:10px; font-size: 18px;text-align:center;">
                                    Expire d'annonce <br>
                            ...
                            <div class="card-body text-center" bis_skin_checked="1">
                                ...
                                <form method="post" action="{{ route('addannonce') }}"
                                    ...
                                    <div class="form-group row">
                                        <label for="staticEmail" class="col-sm-2 col-form-label"><strong
                                                style="color:black">Titre</strong></label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="inputTitre"
                                                oninput="displayInput('inputTitre', 'displayedTitre')" name="titre"
                                                required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="inputPassword" class="col-sm-2 col-form-label">
                                            <strong style="color:black">Description</strong></label>
                                        <div class="col-sm-10">
                                            <textarea class="form-control" id="inputDescription"
                                                oninput="displayInput('inputDescription', 'displayedDescription')" name="des" required></textarea>
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label for="inputPassword" class="col-sm-2 col-form-label"><strong
                                                style="color:black">Date début <span
                                                    style="color: red">*</span></strong></label>
                                        <div class="col-sm-10">
                                            <input type="datetime-local" name="db" class="form-control"
                                                required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="inputPassword" class="col-sm-2 col-form-label"><strong
                                                style="color:black">Date fin <span
                                                    style="color: red">*</span></strong></label>
                                        <div class="col-sm-10">
                                            <input type="datetime-local" name="df" class="form-control"
                                                required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="file" name="image" class="form-control"
                                                id="annonceImage" onchange="displaySelectedImage(this)">
                                        </div>
                                    </div>
                                ...
                                <tbody>
                                    @foreach ($annonce as $p)
                                        <tr style="color:black;">
                                            ...
                                            <td>
                                                <img src="{{ asset('annonce/' . $p->imageannonce) }}" width="80"
                                                    class="img-fluid">
                                            </td>
                                            <td>
                                                {{ $p->db }}
                                            ...
                                            <td>
                                                <a href="#updateannonce{{ $p->id }}" class="btn"
                                                    data-toggle="modal">
