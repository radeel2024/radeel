            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        @can('acceuil')
                            <a class="collapse-item active" href="{{ route('Acceuil') }}"><strong> Article</strong></a>
                        @endcan
                        @can('communication')
            ...
            <div id="content">
                ...
                <div class="container-fluid" style="background: white;">
                    ...
                    <div class=" d-flex justify-content-end" style="padding:12px;">
                        ...
                        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#addo">
                    ...
                    {{-- 
                            ...
                            --}}
                    <br>
                    <table class="table dataTable table-bordered" style="margin:20px">
                        ...
                        <tbody>
                            @foreach ($article as $e)
                                <tr style="color:black">
                                    ...
                                    <td>
                                        <img class="img-profile" src="{{ asset('articlescopie/' . $e->image) }}"
                                            width="70">
                                    </td>
                                    <td>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            <label for="message-text" class="col-form-label"
                                                style="color:black">Images slider :<span style="color:red">( Seul
                                                    images )
                                                    *</span></label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select required class="form-control" style="color:black" name="status">
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-primary crop_image">Enregistrer
                                    </button>
                                </div>
                            </div>
                        </div>
