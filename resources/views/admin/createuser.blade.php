                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="card card-primary">
                                                            ...
                                                            <!-- form start -->
                                                            <form id="quickForm" method="post" action="{{route('store')}}" enctype="multipart/form-data">
                                                                @csrf
                                                                <br>
                                                                <div class="card-body">
                                                                    <div class="row mb-4">
                                                                ...
                                                                <div class="card-footer">
                                                                    ...
                                                                    <button class="btn btn-danger"><a href="{{ route('users') }}" style="color:inherit"> Back</a></button>
