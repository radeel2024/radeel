            ...
            @can('role')
                ...
                <li class="nav-item">
                    ...
                    <div id="collapsethree" class="collapse show" aria-labelledby="collapsethree" data-parent="#collapsethree">
                        <div class="bg-white py-2 collapse-inner rounded">
                            @can('role')
                                <a class="collapse-item active" href="{{route('roles')}}"><strong>Role</strong></a>
                            @endcan
                            @can('users')
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                                            ...
                                                            {!! Form::model($role, ['method' => 'POST ','route' => ['roleupdate', $role->id]]) !!} 
                                                            <div class="row">
                                                                ...
                                                                <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                                                                    ...
                                                                    <a class="btn btn-success" href="{{ route('roles') }}"> Back</a>
