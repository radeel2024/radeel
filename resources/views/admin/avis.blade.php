            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        @endcan
                        @can('avis-coupure')
                            <a class="collapse-item active" href="{{ route('avis') }}"><strong>Avis coupure</strong></a>
                        @endcan
                        @can('zone-speciale')
                            ...
                            <div class="tab" role="tabpanel">
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    <li role="presentation" class="active"><a href="#Section1" aria-controls="home"
                                            role="tab" data-toggle="tab"><strong>Avis de coupure</strong></a>
                                    </li>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <th>
                                                                        <a href="#add" class="btn btn-success"
                                                                            ...
                                                                            <strong> Ajouter une avis de coupure</strong>
                                                                        </a>
                                                                    </th>
                                                                </tr>
                                                            </div>
                                                            ...
                                                            <div class="carousel-inner" style="width: 100%; ">
                                                                @foreach ($avis as $key => $item)
                                                                    <div
                                                                        ...
                                                                        <img src="{{ asset('aviscoupure/' . $item->avis) }}"
                                                                            class="img-fluid"
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" style="color:black"
                                                            id="exampleModalLabel"><strong>Avis coupure</strong></h5>
                                                        <button type="button" class="close" data-dismiss="modal"
                                                            aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
                                                    <form method="post" action="{{ route('addaviscoupure') }}"
                                            ...
                                            <div class="modal fade" id="Edit{{ $f->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" style="color:black"
                                                                id="exampleModalLabel"><strong>Avis coupure</strong>
                                                            </h5>
                                                        ...
                                                        <form method="post"
                                                            action="{{ route('updateaviscoupure', $f->id) }}"
                                                            enctype="multipart/form-data">
                                                            @csrf
                                                            <div class="modal-body">
                                                                {{-- <div class="form-group">
