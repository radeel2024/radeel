                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        @can('ressources-humaines')
                            <a class="collapse-item active" href="{{ route('rh') }}"><strong>Chiffre cles</strong></a>
                        @endcan
            ...
            <div id="content">
                ...
                <div class="container-fluid" style="background: white;">
                    ...
                    <div class="container-fluid">
                        <br><br>
                        <table class="table dataTable table-bordered" style="padding: 20px">
                            <thead>
                        ...
                        <div class="modal fade" id="Editsta{{ $f->id }}" tabindex="-1"
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <form method="post" action="{{ route('updatesta', $f->id) }}"
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" required class="form-control"
                                                    id="recipient-name" name="titre" value="{{ $f->title }}">
                                            </div>

                                            <div class="form-group">
                                                <label for="recipient-name" class="col-form-label"
                                                    style="color:black">Chiffre :</label>
                                                <input type="text" required class="form-control" name="chiffre"
                                                    value="{{ $f->chiffre }}">
                                            </div>
                                        </div>
                                        <div class="modal-footer">
