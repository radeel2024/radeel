                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                       ...
                       <!--  @can('achat-Logistique')
                        ...
                        @endcan -->
                        @can('galerie')
                            <a class="collapse-item active" href="{{ route('album') }}"><strong>Galerie</strong></a>
                        @endcan
                        @can('avis-coupure')
                            ...
                            <div class="tab" role="tabpanel">
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    <li role="presentation" class="active"><a href="#Section1" aria-controls="home"
                                            role="tab" data-toggle="tab"><strong>Galerie</strong></a>
                                    </li>
                                                            ...
                                                            <div class="carousel-inner" style="width: 100%; ">
                                                                ...
                                                                @foreach ($album as $key => $item)
                                                                    <div
                                                                        ...
                                                                        <img src="{{ asset('albume/' . $item->image) }}"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <th>
                                                                        <a href="#add" class="btn btn-success"
                                                                            ...
                                                                            <strong>Ajouter une nouveau image</strong>
                                                                        </a>
                                                                    </th>
                                                                </tr>
                                                            </div>
                                                            <table class="table dataTable table-bordered" style="margin:10px;">
                                                                <thead>
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" style="color:black"
                                                            id="exampleModalLabel"><strong>Galerie</strong></h5>
                                                        <button type="button" class="close" data-dismiss="modal"
                                                            aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
                                                    <form method="post" action="{{ route('addimages') }}"
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="file" class="form-control"
                                                                    id="recipient-name" name="file[]" multiple>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="modal fade" id="Edit{{ $f->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" style="color:black"
                                                                id="exampleModalLabel"><strong>Galerie</strong>
                                                            </h5>
                                                        ...
                                                        <form method="post"
                                                            action="{{ route('updateImages', $f->id) }}"
                                                            enctype="multipart/form-data">
                                                            @csrf
                                                            <div class="modal-body">
                                                                <div class="form-group">
