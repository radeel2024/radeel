            ...
            <li class="nav-item">
                ...
                <div id="collapsefoure" class="collapse show" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        @can('role')
                            <a class="collapse-item active" href="{{ route('statistique') }}"><strong>Admin</strong></a>
                        @endcan
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                    Abonnement</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{$abonementcount}}</div>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                    Racoredement</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{$racoredementcount}}</div>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                    Resilation</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{$resilationcount}}</div>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{$avisrectutementcount}}</div>
                                ...
                                <div class="card border-left-warning shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                    demande de stage</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{$demandestagecount}}</div>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                    Avis de coupure</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{$aviscoupurecount}}</div>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                    galerie</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{$galriecount}}</div>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                    Appels offre</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{$appelsoffrecount}}</div>
                                            </div>
