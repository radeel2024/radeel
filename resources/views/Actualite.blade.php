                ...
                <ul>
                    ...
                    <li class="dropdown"><a class="nav-link active"><span>PRATIQUE</span> <i
                        ...
                        <ul>
                            ...
                            <li><a href="{{ url('../') }}" class="dropdown-item">Audiovisuel</a></li>
            ...
            <div class="row g-4">
                @foreach ($article as $e)
                    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item rounded overflow-hidden" style="height:370px;">
                            <img src="{{ asset('articlescopie/' . $e->image) }}" class="img-fluid" width="100%"
                                style="height: 200px;">
