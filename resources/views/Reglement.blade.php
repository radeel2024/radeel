            ...
            <div class="  row g-5">
                <div class=" col-lg-5 col-md-6 col-sm-12 wow fadeIn" data-wow-delay=".3s">
                    <div class="h-100 position-relative">
                        <img src="https://cms.weka.ch/fileadmin/_processed_/b/7/csm_Le_reglement_du_personnel_nouveau_3dfac575a7.jpg" class="img-fluid shadow-sm w-85 rounded"
                ...
                <div class="col-lg-7 col-md-6 col-sm-12 wow fadeIn" data-wow-delay=".5s"><br>
                    <h1 style="color:#D6821E;"> <a  style="color:#D6821E;"
                            width="100%">Règlement des marchés</a> </h1><br>
                ...
                <div class="container">
                    ...
                    <div class=" h-100 position-relative" id="detail">
                        <div class="container" id="reglement">
                            <embed src="/img/reglement-des-marches-publics-RADEEL_3.pdf" type="application/pdf" width="100%" height="700">
                        </div>
                    </div>
                    <br><br>
                </div>
