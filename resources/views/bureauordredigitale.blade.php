...
*/
    ...
    <div class="container-fluid page-headere py-5">
        <div class="container text-center py-5">
            <h1 class="display-2 text-white mb-4 animated slideInDown">Bureau d’Ordre Digital</h1>
        </div>
    </div>
    <!-- Page Header End -->
    ...
    <!-- About Start -->
    <br>
    <div cass="container-fluid py-5 mb-5">
        <div class="container">

            <div class="row" style="padding:20px">
                <p style="color: gray;">Le Bureau d’Ordre Digital est une plateforme digitale nationale, destinée aux
                    usagers des organismes publics en leur permettant de déposer, d’une manière électronique et
                    sécurisée, des courriers auprès de ces organismes, dans le but de limiter l'échange physique de
                    documents administratifs.</p>
                <p style="color: gray;">Les citoyens, entreprises, administrations et institutions publiques peuvent
                    déposer leur correspondance avec accusé de réception via cette plateforme. Vous pouvez accéder au
                    portail du bureau de contrôle numérique via ce
                ...
                <br><br><br><br>
                    ...
                    <p class="text-center">
                        <a href="https://bodigital.gov.ma/index.php?page=courrier.FormulaireDemande&idOrg=11288&lang=ar&h=46e10206f8fcbd452301311ca8a164d41ebc093eaca134b694f999ced1b39f21" 
                        class="btn btn" style='background-color:#D1801D; color: white;padding:15px;text-align: center;text-decoration: underline;font-weight: bolder;'> <i class="fas fa-share-square"></i> Cliquer ici </a></p>
            </div>
        ...
        <div class="reseau">
            <ul>
                ...
                <li class="linkdin">
                    ...
                    <div class="slider">
                        <p> <a href="https://ma.linkedin.com/company/radeelofficiel" style="color:white;">linkden</a>
                        </p>
                    </div>
                </li>
                <li class="youtube">
