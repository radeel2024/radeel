...
<html lang="en">
    ...
    <head>
        ...
        <style>
            .page-headere {
                    background: linear-gradient(rgba(0, 0, 0, .6), rgba(0, 0, 0, .6)), url(img/loi.jpg) center center no-repeat;
    ...
    <body>
            ...
            <div class="container">
                <nav class="navbar navbar-expand-lg py-0 " >
                    <a href="index.html" class="navbar-brand">
                        <h1 class="text-white fw-bold d-block"><img src="https://www.radeel.ma/images/radeel-logo-1x1.png" width="70"> </h1>
                    </a>
                    <button type="button" class="navbar-toggler me-0" data-bs-toggle="collapse" data-bs-target="#navbarCollapse">
                        <span class="navbar-toggler-icon"></span>
                    </button>
                    <div class="collapse navbar-collapse bg-transparent" id="navbarCollapse" style="padding-left:400px;">
                        <div class="navbar-nav ms-auto mx-xl-auto p-0" >
                            <a href="index.html" class="nav-item nav-link" >Acceuil</a>
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown">RADEEL</a>
                                <div class="dropdown-menu rounded">
                                    <a href="PresentationRADEEL.HTML #motsDirecteur" class="dropdown-item">Mots du Directeur Général </a>
                                    <a href="PresentationRADEEL.HTML #Structure" class="dropdown-item">Structure RADEEL</a>
                                    <a href="PresentationRADEEL.HTML #Activite" class="dropdown-item">  Activité </a>
                                </div>
                            </div>
                            <div class="nav-item dropdown">
                                <a href="#serviceID" class="nav-link dropdown-toggle" >Nos services</a>
                             <!--    <div class="dropdown-menu rounded">
                            ...
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Espace RH </a>
                                <div class="dropdown-menu rounded">
                                    <div class="dropdown-menu rounded">
                                        <a href="loi.html" class="dropdown-item">Loi cadre</a>
                                        <a href="avis.html" class="dropdown-item">Avis de recrutement</a>
                                        <a href="stage.html" class="dropdown-item">Stages</a>
                                    </div>
                                </div>
                            </div>
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Fournisseurs</a>
                                <div class="dropdown-menu rounded">
                                    <a href="blog.html" class="dropdown-item">Our Blog</a>
                                    <a href="team.html" class="dropdown-item">Our Team</a>
                                    <a href="testimonial.html" class="dropdown-item">Testimonial</a>
                            ...
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Pratiques</a>
                                <div class="dropdown-menu rounded">
                                    <a href="blog.html" class="dropdown-item">Our Blog</a>
                                    <a href="team.html" class="dropdown-item">Our Team</a>
                                    <a href="testimonial.html" class="dropdown-item">Testimonial</a>
                            ...
                            <a href="index.html #contactID" class="nav-item nav-link">Contact</a>
                        </div>
                    </div>
        ...
        <!-- Page Header Start -->
        <div class="container-fluid py-0" style="background-image:url('https://www.bladi.net/img/logo/arton62659.jpg'); background-repeat: no-repeat; background-size: cover; width:100%;  ">
            <div class="container text-center py-5" >
                <h1 class="display-2 text-white mb-4 animated slideInDown">Presentation RADEEL</h1>
            </div>
        </div>
    ...
    <div class="container-fluid footer wow fadeIn" data-wow-delay=".3s" style="background: #077ec0;">
        ...
        <!-- Back to Top -->
        <a href="#" class="btn  btn-square rounded-circle back-to-top" style="background-color: #077ec0;"><i class="fa fa-arrow-up text-white"></i></a>
