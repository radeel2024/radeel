...
<head>
    ...
    <style>
        .page-headere {
            background-image: url('https://www.straightway-logistics.com/repository/image/eb0739d3-a1c7-4cae-a2b0-183c4555c035.jpg');
        ...
        <div class="container">
            <div class="d-flex justify-content-between topbar">
                ...
                <div id="note" class="text-secondary d-none d-xl-flex text-white">
                    <small><a href="../tel:0801000042" style="color:white;text-decoration: none;">ALLO Radeel 08 01 00
                            00
                            42</a></small>
                </div>
                <div class="top-link">
...
*/
    ...
    <!--   <div class="container-fluid page-headere py-5">
            <div class="container text-center py-5">
                <h1 class="display-2 text-white mb-4 animated slideInDown">Couper
    ...
    <!--   <div class="row">
            <div class="col" style="padding: 40px;">
                <a href="../#">
                    <img
                        src="../../https://www.radeel.ma/images/radeel-images/blog/2023/Avis-d-une-interruption-de-l-alimentation-eau-le-29-08-2023-Quartier-administratif-Cercle-khmis-sahel.jpg"
