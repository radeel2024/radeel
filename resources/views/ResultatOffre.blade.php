 ...
 -->                            <li><a href="{{ url('../Avis recrutement') }}" class="dropdown-item">Avis de
                    ...
                    <li class="dropdown"><a href="#"><span>PRATIQUE</span> <i
                        ...
                        <ul>
                            ...
                            <li><a href="{{ url('../') }}#AudioVisual" class="dropdown-item">Galerie / Audiovisual</a></li>
    ...
    <!-- Page Header Start -->
    <div class="container-fluid page-headere" style="height:300px;">
        <div class="container text-center py-5">
            <h1 class="display-2 text-white mb-4 animated slideInDown"> Résultat Appels Offres
            </h1>
        </div>
    </div>
    <!-- Page Header End -->
    <div class="container" style="cursor: pointer">
        ...
        <div class="row  bg-white rounded-xl shadow-sm px-7 py-5 p-md-5" style="margin-top:60px;">
            <div class="container d-flex align-items-start">
                <div class="tab-content rounded-3  p-3 text-danger w-100" id="pills-tabContent">
                    {{--   @foreach ($result as $index => $r)
                        <div class="tab-pane fade {{ $index === 0 ? ' show active' : '' }} " id="pills-tab-{{ $index }}" role="tabpanel"
                            aria-labelledby="pills-tab-{{ $index }}-label" style="margin:5px">
                            <div class="accordion-item-{{ $index }}">
                                <div data-bs-toggle="collapse" data-bs-target="#collapse-{{ $index }}"
                                    aria-expanded="true" aria-controls="collapse-{{ $index }}"
                                    style="padding: 30px" >
                                    <strong style="color:#d4811d;"> Résultat Appels Offres N ° :
                                        {{ $r->appele_offer }}
                                    </strong>
                                </div>
                                <div id="collapse-{{ $index}}" class="accordion-collapse collapse"
                                    aria-labelledby="heading-{{ $index }}" data-bs-parent=".accordion-item-{{ $index }}" >
                                    <div class="accordion-body">
                                        <div class="container-fluid">
                                            <div class="container">
                                                <img src="{{ asset('resultatappeloffer/' . $r->file) }}"
                                                    width="1000px">
                                            </div>
                                        </div>
                                    </div>
                ...
                @endforeach  --}}
                    {{--   @foreach ($result as $index => $r)
                        <div class="tab-pane fade {{ $index === 0 ? ' show active' : '' }}"
                            id="pills-tab-{{ $index }}" role="tabpanel"
                            aria-labelledby="pills-tab-{{ $index }}-label" style="margin:5px">
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="heading-{{ $index }}">
                                        <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                            ...
                                            aria-controls="collapse-{{ $index }}" style="padding: 30px">
                                            <strong style="color:#d4811d;">Résultat Appels Offres N° :
                                                {{ $r->appele_offer }}</strong>
                                        </button>
                                    </h2>
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        @foreach ($result as $index => $r)
                            <div class="nav-link {{ $index === 0 ? 'active' : '' }}"
                                id="pills-tab-{{ $index }}-tab" data-bs-toggle="pill"
                                data-bs-target="#pills-tab-{{ $index }}" type="button" role="tab"
                                aria-controls="pills-tab-{{ $index }}"
