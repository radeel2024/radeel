...
*/
    ...
    <div class="container-fluid page-headere py-5">
        <div class="container text-center py-5">
            <h1 class="display-2 text-white mb-4 animated slideInDown">Loi cadre</h1>
        </div>
    </div>
    <!-- Page Header End -->
    <!-- About Start -->
            ...
            <div class="row g-5">
                <div class="col-lg-5 col-md-6 col-sm-12 wow fadeIn" data-wow-delay=".3s">
                    <div class="h-100 position-relative">
                        <img src="https://www.conseil-national.mc/wp-content/uploads/2019/07/textes-de-lois-960x640.jpg"
                            class="img-fluid shadow-lg w-75 rounded" alt="" style="margin-bottom: 25%;">
                        <div class="position-absolute w-75" style="top: 25%; left: 25%;">
                            <img src="https://aijedroit.com/wp-content/uploads/2021/11/Nul-nest-cense-ignorer-la-loi.jpg"
                                class="img-fluid shadow-lg w-100 rounded" alt="">
                        </div>
                    </div>
                </div>
                <br><br><br>
                <div class="col-lg-7 col-md-6 col-sm-12 wow fadeIn" data-wow-delay=".5s">
                    <h1 class="mb-4">Loi cadre Radeel</h1>
                    ...
                    <p class="mb-4">Cet établissement a été crée en janvier 1996 conformément au décret n° 2-64-394
                        du 22 joumada I 1384 (29 septembre 1964), aux délibérations du syndicat des communes et à
                        l’arrêté de Monsieur le Ministre de l’intérieur n° 9-95-96.</p>
                </div>
            </div>
        </div>
    </div>
