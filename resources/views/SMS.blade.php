        ...
        <nav id="navbarNav navbar-expand-sm " class="navbar ">
         <button class="navbar-toggler" type="button" data-bs-toggle="collapse"
            ...
            <ul>
                ...
                <li class="dropdown" Style="color:black;" ><a class="nav-link active"><span>ESPACE CLIENT</span> <i
    ...
    <div class="container-fluid py-5 my-5">
        <div class="container ">
            <div class=" row g-5">
                ...
                <div class="container">
                    <h2 class="text-center py-3" style="color:#077ec0">Guide de saisie les données en ligne </h2>
                    <br><br>
